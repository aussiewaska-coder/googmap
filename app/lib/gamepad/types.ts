...
export const ACTION_DEFINITIONS: readonly ActionDefinition[] = [
    ...
    { key: 'zoom', label: 'Zoom (Analog)', description: 'Zoom in/out smoothly', type: 'axis' },
    { key: 'zoom_in', label: 'Zoom In', description: 'Discrete zoom in', type: 'button' },
    { key: 'zoom_out', label: 'Zoom Out', description: 'Discrete zoom out', type: 'button' },
